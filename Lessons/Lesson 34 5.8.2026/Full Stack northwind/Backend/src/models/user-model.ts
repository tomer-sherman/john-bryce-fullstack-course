...
const userSchema = z.object({
    ...
    // Not a users table column - sent by the frontend on register, verified against Google, then discarded:
    captchaToken: z.string().min(1, "Please check the I'm not a robot checkbox"),
});
