...
console.log("Hello");
let age; // Lets you edit you'r type of var, you cannot change this var too a string.
age = 20;
console.log(`age: ${age}`);
...
let message; // you can choose which type of var it will be, UNION TYPE
message = "Amazing";
message = 42;
message = true;
...
let car; // THIS SOLIDIFIES the object. you can now put values inside according too the type.
