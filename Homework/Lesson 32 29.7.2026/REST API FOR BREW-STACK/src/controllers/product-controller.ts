...
class ProductController {
    ...
    public constructor() {
        this.router.get("/api/products", securityMiddleware.verifyLoggedIn, this.getAllProducts);
        this.router.get("/api/products/:id", securityMiddleware.verifyLoggedIn, this.getOneProduct);
        this.router.post("/api/products", securityMiddleware.verifyAdmin, this.addProduct);
        this.router.put("/api/products/:id", securityMiddleware.verifyAdmin, this.updateProduct);
